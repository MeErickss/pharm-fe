...
export function ParametersStorage({ onClose }) {
  ...
  return (
    <div className="w-full h-full p-4 bg-gray-100">
      <h2><strong>Parametros Armazem</strong></h2>
      <div className="grid grid-rows-[auto_1fr_auto] grid-cols-7">
        <div className="grid bg-gray-200 border-b-2 border-gray-300 p-2">
          Parametro
        </div>
        <div className="grid bg-gray-200 border-b-2 border-gray-300 p-2">
          Tipo
