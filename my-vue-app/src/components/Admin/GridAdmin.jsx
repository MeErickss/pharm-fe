      ...
      {dados.map((row) => (
        ...
        >
          {Object.values(row).map((value, idx) => (
            <div key={idx} className={value == "ATIVO" ? "w-1/2 border-b-2 border-green-400 px-2": value == "INATIVO" ? "border-b-2 border-b-yellow-400 px-2" : value == "BLOQUEADO" ? "border-b-2 border-b-red-400 px-2" : "px-2"}>
              {value}
            </div>
          ))}
