    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
      <div className="w-full max-w-5xl max-h-[90vh] overflow-auto bg-neutral-100 p-6 rounded-2xl shadow-lg relative">
        <header className="flex justify-between items-center mb-4">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" width="16" className="cursor-pointer text-gray-500 hover:text-gray-800 fill-red-500 hover:fill-red-900">
