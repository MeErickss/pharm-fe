    ...
    return (
      <div className="fixed top-1 left-1/4 w-[72rem] h-[60rem] bg-slate-200 p-4 rounded shadow-lg">
          <table className="border-2 border-collapse border-black text-xs mb-3 w-[67rem]">
            <thead>
              <tr className="border-2 border-collapse border-black">
                <th className="border-2 border-collapse border-black">TEMPOS PRODUÇÃO ÁCIDO</th>
                <th className="border-2 border-collapse border-black">UNID</th>
                <th className="border-2 border-collapse border-black">VALOR</th>
                <th className="border-2 border-collapse border-black">VL.MIN</th>
                <th className="border-2 border-collapse border-black">VL.MAX</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                ...
                <td className="border-2 border-collapse border-black"><input className="w-full" type="text"/></td>
                <td className="border-2 border-collapse border-black"><input className="w-full" type="text"/></td>
                <td className="border-2 border-collapse border-black"><input className="w-full" type="text"/></td>
              </tr>
              <tr>
          ...
          <table className="border-2 border-collapse border-black text-xs mb-3 w-[67rem]">
            <thead>
              <tr className="border-2 border-collapse border-black">
                <th className="border-2 border-collapse border-black">PARÂMETROS PRODUÇÃO ÁCIDO</th>
                <th className="border-2 border-collapse border-black">UNID</th>
                <th className="border-2 border-collapse border-black">VALOR</th>
                <th className="border-2 border-collapse border-black">VL.MIN</th>
                <th className="border-2 border-collapse border-black">VL.MAX</th>
          ...
          <table className="border-2 border-collapse border-black text-xs mb-3 w-[67rem]">
            <thead>
              <tr className="border-2 border-collapse border-black">
                <th className="border-2 border-collapse border-black">TEMPOS PRODUÇÃO BICARBONATO</th>
                <th className="border-2 border-collapse border-black">UNID</th>
                <th className="border-2 border-collapse border-black">VALOR</th>
                <th className="border-2 border-collapse border-black">VL.MIN</th>
                <th className="border-2 border-collapse border-black">VL.MAX</th>
          ...
          <table className="border-2 border-collapse border-black text-xs mb-3 w-[67rem]">
            <thead>
              <tr className="border-2 border-collapse border-black">
                <th className="border-2 border-collapse border-black">PARÂMETROS PRODUÇÃO BICARBONATO</th>
                <th className="border-2 border-collapse border-black">UNID</th>
                <th className="border-2 border-collapse border-black">VALOR</th>
                <th className="border-2 border-collapse border-black">VL.MIN</th>
                <th className="border-2 border-collapse border-black">VL.MAX</th>
          ...
          <table className="border-2 border-collapse border-black text-xs mb-3 w-[67rem]">
            <thead>
              <tr className="border-2 border-collapse border-black">
                <th className="border-2 border-collapse border-black">SETUP DE INSTRUMENTOS</th>
                <th className="border-2 border-collapse border-black">UNID</th>
                <th className="border-2 border-collapse border-black">VALOR</th>
                <th className="border-2 border-collapse border-black">VL.MIN</th>
                <th className="border-2 border-collapse border-black">VL.MAX</th>
          ...
          <table className="border-2 border-collapse border-black text-xs mb-3 w-[67rem]">
            <thead>
              <tr className="border-2 border-collapse border-black">
                <th className="border-2 border-collapse border-black">TEMPO PARA FALHA DE VÁLVULAS</th>
                <th className="border-2 border-collapse border-black">UNID</th>
                <th className="border-2 border-collapse border-black">VALOR</th>
                <th className="border-2 border-collapse border-black">VL.MIN</th>
                <th className="border-2 border-collapse border-black">VL.MAX</th>
